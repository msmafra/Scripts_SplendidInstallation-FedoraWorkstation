...
Install_Fonts() {
    ...
    then
        ...
        tar --extract --zstd --file="$WORKINGDIRECTORY"/Fonts/Fonts-Google.tar.zst --directory "$HOME"/.local/share/fonts/Google/
    ...
    then
        ...
        tar --extract --zstd --file="$WORKINGDIRECTORY"/Fonts/Fonts-Microsoft.tar.zst --directory "$HOME"/.local/share/fonts/Microsoft/
